...
const inputFile = './bb/city_code_13.json'; // Replace with your input JSON file
const outputFile = './cc/city_code_master_id_13.json'; // The name of the output JSON file
