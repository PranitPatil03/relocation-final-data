...
(async () => {
  try {
    ...
    const sourceFile = "./finaldata/s/split_city_code_master_5.json"; // Replace with your actual source file
    const destinationFile = "./finaldata/d/split_city_code_master_5.json"; 
    ...
    const outputFile = "./finalR/results_5.json";
