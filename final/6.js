...
const tempFile = "./temp/results_temp_6.json";
...
(async () => {
  try {
    ...
    const sourceFile = "./data/data_source_6.json"; // Replace with your actual source file
    const destinationFile = "./data/data_destination_6.json"; // Replace with your actual destination file
    ...
    const outputFile = "./final/results_6.json";
