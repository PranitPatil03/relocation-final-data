...
(async () => {
  try {
    ...
    const sourceFile = "./finaldata/s/split_city_code_master_6.json"; // Replace with your actual source file
    const destinationFile = "./finaldata/d/split_city_code_master_6.json"; 
    ...
    const outputFile = "./finalR/results_6.json";
