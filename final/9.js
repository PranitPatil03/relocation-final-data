...
const tempFile = "./temp/results_temp_9.json";
...
(async () => {
  try {
    ...
    const sourceFile = "./finaldata/s/split_city_code_master_9.json"; // Replace with your actual source file
    const destinationFile = "./finaldata/d/split_city_code_master_9.json"; 
    ...
    const outputFile = "./finalR/results_9.json";
