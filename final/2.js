...
(async () => {
  try {
    ...
    const sourceFile = "./data/data_source_2.json"; // Replace with your actual source file
    const destinationFile = "./data/data_destination_2.json"; 
    ...
    const outputFile = "./final/results_2.json";
