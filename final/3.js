...
const tempFile = "./temp/results_temp_3.json";
...
(async () => {
  try {
    ...
    const sourceFile = "./finaldata/s/split_city_code_master_3.json"; // Replace with your actual source file
    const destinationFile = "./finaldata/d/split_city_code_master_3.json"; 
    ...
    const outputFile = "./finalR/results_3.json";
