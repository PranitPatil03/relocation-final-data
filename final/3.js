...
(async () => {
  try {
    ...
    const sourceFile = "./data/data_source_3.json"; // Replace with your actual source file
    const destinationFile = "./data/data_destination_3.json"; 
    ...
    const outputFile = "./final/results_3.json";
