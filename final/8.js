...
(async () => {
  try {
    ...
    const sourceFile = "./data/data_source_8.json"; // Replace with your actual source file
    const destinationFile = "./data/data_destination_8.json";
    ...
    const outputFile = "./final/results_8.json";
