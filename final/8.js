...
const tempFile = "./temp/results_temp_8.json";
...
(async () => {
  try {
    ...
    const sourceFile = "./finaldata/s/split_city_code_master_8.json"; // Replace with your actual source file
    const destinationFile = "./finaldata/d/split_city_code_master_8.json"; 
    ...
    const outputFile = "./finalR/results_8.json";
