...
const tempFile = "./temp/results_temp_7.json";
...
(async () => {
  try {
    ...
    const sourceFile = "./finaldata/s/split_city_code_master_7.json"; // Replace with your actual source file
    const destinationFile = "./finaldata/d/split_city_code_master_7.json"; 
    ...
    const outputFile = "./finalR/results_7.json";
