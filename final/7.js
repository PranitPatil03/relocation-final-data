...
(async () => {
  try {
    ...
    const sourceFile = "./data/data_source_7.json"; // Replace with your actual source file
    const destinationFile = "./data/data_destination_7.json";
    ...
    const outputFile = "./final/results_7.json";
