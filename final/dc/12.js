...
const inputFile = './bb/city_code_12.json'; // Replace with your input JSON file
const outputFile = './cc/city_code_master_id_12.json'; // The name of the output JSON file
